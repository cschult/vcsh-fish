...
if command ls --version >/dev/null 2>/dev/null
    ...
    function ls --description "List contents of directory"
        set -l param --color=auto --group-directories-first --quoting-style=literal
        if isatty 1
            set -a param --group-directories-first --quoting-style=literal
        end
